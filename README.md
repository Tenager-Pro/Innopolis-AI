...
# Быстрый старт
Для запуска проекта по созданию модели начните с файла main в  корне он позволит создать все базовые настройки для дальнейшей работы с notebook

Для запуска api требуется перейти в раздел api и запустить main 
